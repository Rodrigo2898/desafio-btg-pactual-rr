package com.ms.rr.orderms.service;
...
import com.ms.rr.orderms.repository.OrderRepository;
...
class OrderServiceTest {
    ...
    @Captor
    ArgumentCaptor<OrderEntity> entityArgumentCaptor;
    ...
    class Save {
        ...
        void shouldMapEventToEntityWithSuccess() {
            ...
            // ASSERT
            verify(orderRepository, times(1)).save(entityArgumentCaptor.capture());

            var entity = entityArgumentCaptor.getValue();
    ...
    class FindAllByCustomerId {
        ...
        void shouldCallRepository() {
            ...
            doReturn(OrderEnityFactory.buildWithPage())
        ...
        void shouldMapResponse() {
            ...
            var customerId = 1L;
            var pageRequest = PageRequest.of(0, 10);
            var page = OrderEnityFactory.buildWithPage();
            doReturn(page)
